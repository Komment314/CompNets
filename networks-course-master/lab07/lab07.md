...
4. Какой порядковый номер у SYNACK-сегмента, отправленного сервером gaia.cs.umass.edu
   ...
   - Прибавил 1 к значению из SYN сегмента
   - Флаги в заголовке
...
![](1_6.png)
   - Раньше HTTP запроса, после привязки
   - *0.128599000 seconds*
7. Чему равна пропускная способность (количество байтов, передаваемых в единицу
   ...
   - $\approx 10281$
   - Взял сдернее отношение длины пакета к скорости
